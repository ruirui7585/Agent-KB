...
function main() {
  ...
  const marker = "prototype-annotation runtime";
  const snippet = [
    `<!-- ${marker} -->`,
  ...
  if (html.includes("prototype-agent-annotation runtime")) {
    throw new Error("Legacy prototype-agent-annotation runtime detected; migrate or remove it before injecting prototype-annotation.");
  }

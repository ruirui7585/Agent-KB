...
| `cameraState.mealType` | 当前餐别 | breakfast/lunch/dinner/snack | breakfast | 拍照与克重模式的四按钮餐别选择、保存记录 | 用户点击餐别按钮 |
...
| photo_result_portion_edit | 拍照识别结果份量修正 | 0–5000g | AI 识别克重 | 该食物热量、区间、三大营养素及整餐总热量 | 用户修改识别结果中的份量 |
| result_nutrition_distribution | 识别结果的三大营养素分布 | 蛋白质/碳水/脂肪克重与热量占比 | AI 营养素字段汇总 | 结果页三列营养摘要 | 初次识别、份量修改、删除食物 |
| result_ingredient_card | 识别结果食材卡 | collapsed/editing | collapsed | 食材摘要、名称/克重/热量编辑 | 点击食材卡、“修正结果”或键盘 Enter/Space |
...
| `dailyNutritionGoals` | 每日营养目标 | protein/carbs/fat g | 80/180/45 | 我的页营养目标配置 | 用户保存全部设置 |
| `dashboardNutritionProgress` | 首页三大营养素摄入进度 | 今日摄入 g / 每日目标 g，0–100% | 0 / 目标值 | 首页营养摄入卡 | 饮食记录或营养目标变化 |
| `bodyProjection.fat_change` | 热量差对应的脂肪能量等价 | today/week/month kg | 0 | 首页脂肪变化卡 | 首页数据刷新 |
| `bodyProjection.body_fat` | 当前体脂率及 7 天、30 天预计升降百分点 | percentage/null | `null` | 首页身体变化卡的体脂率变化区 | 个人资料或热量差变化 |
...
8. 三大营养素目标独立于每日热量目标保存；未保存时按蛋白质 80g、碳水 180g、脂肪 45g 展示。
9. 首页营养摄入从当天全部餐次的食物营养字段汇总；超出目标时进度条封顶 100% 并显示超标色。
10. 识别结果食材卡默认展示名称、热量、克重和置信度；点击展开后继续使用原有名称、克重、热量编辑与联动逻辑。

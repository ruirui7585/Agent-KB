...
const attachmentMediaLibrary = {
  myPhoto: [
    { id: "my_photo_01", mediaType: "photo", title: "Brunch photo", src: "./assets/photos/discover_01.jpg", fallback: createFallbackSvg("P1", "#A855F7", "#7C3AED") },
    { id: "my_photo_02", mediaType: "photo", title: "Cafe portrait", src: "./assets/photos/discover_02.jpg", fallback: createFallbackSvg("P2", "#EC4899", "#BE185D") },
    { id: "my_video_01", mediaType: "video", title: "Weekend video", src: "./assets/photos/discover_03.jpg", fallback: createFallbackSvg("V1", "#111827", "#A855F7") },
    { id: "my_photo_03", mediaType: "photo", title: "Travel photo", src: "./assets/photos/discover_04.jpg", fallback: createFallbackSvg("P3", "#10B981", "#059669") },
    { id: "my_video_02", mediaType: "video", title: "City walk video", src: "./assets/photos/discover_05.jpeg", fallback: createFallbackSvg("V2", "#18181B", "#8B5CF6") },
    { id: "my_photo_04", mediaType: "photo", title: "Profile photo", src: "./assets/photos/discover_06.png", fallback: createFallbackSvg("P4", "#F59E0B", "#EF4444") }
  ],
  privateAlbum: [
    { id: "album_photo_01", mediaType: "photo", title: "Private photo 1", src: "./assets/photos/discover_05.jpeg", fallback: createFallbackSvg("A1", "#A855F7", "#7C3AED") },
    { id: "album_photo_02", mediaType: "photo", title: "Private photo 2", src: "./assets/photos/discover_06.png", fallback: createFallbackSvg("A2", "#EC4899", "#BE185D") },
    { id: "album_video_01", mediaType: "video", title: "Private video 1", src: "./assets/photos/discover_07.png", fallback: createFallbackSvg("AV1", "#18181B", "#A855F7") },
    { id: "album_photo_03", mediaType: "photo", title: "Private photo 3", src: "./assets/photos/discover_08.png", fallback: createFallbackSvg("A3", "#10B981", "#059669") },
    { id: "album_video_02", mediaType: "video", title: "Private video 2", src: "./assets/photos/discover_09.png", fallback: createFallbackSvg("AV2", "#312E81", "#D946EF") },
    { id: "album_photo_04", mediaType: "photo", title: "Private photo 4", src: "./assets/photos/discover_10.png", fallback: createFallbackSvg("A4", "#F59E0B", "#EF4444") }
  ]
};
  ...
  chatDetail: [
    {
      ...
      notes: {
        business: "我方从相册或私密相册选择一组私密照片 / 视频发送给对方，用于模拟阅后限时可见内容。",
        ui: "发送后在 IM 中展示一张私密内容组卡片，标明包含 2 photos 和 1 video。",
        interaction: "点击 Send media 打开选择面板，发送后插入内容组卡片；对方查看免费，不触发金币或订阅收银台。",
        stateRules: "内容组状态从 draft 到 sent_unopened；对方查看后进入 opened_countdown，倒计时结束后 destroyed。",
        edgeCases: "同一内容组不可重复发送；已销毁后不可再次查看。",
        acceptance: "发送后只出现一张内容组卡片，点击免费进入 10:00 倒计时，模拟结束后展示已销毁。"
      },
      tracking: [
        { event: "private_content_group_send", trigger: "发送私密内容组", params: ["thread_id", "photos_count", "videos_count"] },
        { event: "private_content_group_open", trigger: "对方查看内容组", params: ["thread_id", "group_id"] }
      ]
    },
    {
      id: "chat_private_content_countdown",
      title: "查看倒计时",
      controlType: "state",
      moduleId: "chat_private_photo_unlock",
      notes: {
        business: "对方查看我方发送的私密内容组后，内容在 10 分钟内可见。",
        ui: "内容组卡片展示倒计时和 Available for 10 minutes 文案。",
        interaction: "点击未查看内容组后直接进入倒计时，不需要付费确认。",
        stateRules: "opened_countdown 状态展示 10:00，倒计时结束后切到 destroyed。",
        edgeCases: "刷新或切换页面时仍保持当前演示状态。",
        acceptance: "对方查看后不出现 coin_recharge 或 subscription_paywall。"
      },
      tracking: [
        { event: "private_content_group_countdown_start", trigger: "对方首次查看", params: ["thread_id", "group_id"] }
      ]
    },
    {
      id: "chat_private_content_destroyed",
      title: "内容销毁",
      controlType: "state",
      moduleId: "chat_private_photo_unlock",
      notes: {
        business: "倒计时结束后，私密内容组进入销毁态，无法再次查看。",
        ui: "卡片置灰并展示 Content destroyed。",
        interaction: "点击已销毁内容只给轻量反馈，不重新打开内容。",
        stateRules: "destroyed 状态不可回到 opened_countdown，除非重新选择新的内容组。",
        edgeCases: "已销毁内容不可再次解锁或触发充值。",
        acceptance: "模拟倒计时结束后，卡片展示已销毁且不可查看。"
      },
      tracking: [
        { event: "private_content_group_destroyed", trigger: "倒计时结束", params: ["thread_id", "group_id"] }
      ]
    }
  ],
  me: []
...
const privateVideoMessageTemplates = {
  legacy_chat_001: {
    id: "msg_private_video_01",
    contentId: "private_video_001",
    contentType: "private_video",
    sender: "her",
    type: "private_video",
    status: "locked",
    photoIds: ["private_02"],
    previewImage: "./assets/photos/discover_06.png",
    unlockType: "single_video",
    priceCoins: 180,
    bundlePriceCoins: 399,
    bundleCount: 1,
    copy: {
      lockedTitle: "Private video",
      lockedDesc: "Unlock to play her private video",
      singleCta: "Unlock video",
      bundleCta: "Unlock video"
    }
  }
};
...
const pageConfigs = {
  ...
  chat: {
    pageName: "Chat",
    description: "IM 对话、付费消息、私密内容解锁和金币消耗链路。",
    modules: {
      chat_primary: {
        type: "Chat List",
      ...
      chat_private_photo_unlock: {
        type: "Private Content Group",
        selector: "[data-module-id='chat_private_photo_unlock']",
        title: "Private Content Group",
        notes: {
          business: "用于说明我方选择 2 张私密照片和 1 个私密视频后，以内容组卡片发送给对方。",
          ui: "内容组卡片展示 Private content、2 photos · 1 video，以及未查看 / 倒计时 / 已销毁状态。",
          interaction: "Send media 面板模拟选择内容组并发送；对方点击后免费查看并进入 10 分钟倒计时。",
          stateRules: "该链路不扣金币、不触发订阅；同一内容组发送后不可重复发送。",
          edgeCases: "已销毁内容不可再次查看；重复发送同一组内容只提示不能重复。",
          acceptance: "发送、查看倒计时、销毁三种演示状态清晰且不影响普通聊天。"
        },
        matrix: [
          { state: "draft", behavior: "已模拟选择 2 图 1 视频，尚未发送" },
          { state: "sent_unopened", behavior: "IM 中展示私密内容组卡片，等待对方查看" },
          { state: "opened_countdown", behavior: "对方已查看，展示 10:00 倒计时" },
          { state: "destroyed", behavior: "倒计时结束，展示已销毁" }
        ],
        flow: ["Send media → Select 2 photos + 1 video", "Tap Send private content → Insert group card", "Receiver opens → 10:00 countdown", "Countdown ends → Content destroyed"],
        tracking: [{ event: "private_content_group_send", trigger: "Tap Send private content", params: ["thread_id", "photos_count", "videos_count"] }],
        states: annotationStateActions
      }
    }
  },

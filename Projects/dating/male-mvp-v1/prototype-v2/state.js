const prototypeState = {
  ...
  activePrivateContentType: "private_photo",
  privateContentStatus: "not_sent",
  sentPrivateContentIds: [],
...
const stateOptions = {
  currentPage: ["discover", "likes", "matches", "chat", "me", "profile", "discoverSettings", "privateAlbum"],
  ...
  privateContentStatus: ["not_sent", "sent_locked", "unlocked_countdown", "destroyed", "already_sent"],
  privateContentGroupStatus: ["draft", "sent_unopened", "opened_countdown", "destroyed"],
  ...
  attachmentPickerTab: ["my_photo", "private_album"],
...
function syncDerivedState() {
  ...
  const albumItemCount = (Number(prototypeState.privatePhotoCount) || 0) + (Number(prototypeState.privateVideoCount) || 0);
  if (albumItemCount <= 0) {
